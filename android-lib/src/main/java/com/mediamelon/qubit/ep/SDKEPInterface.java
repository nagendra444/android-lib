...
public interface SDKEPInterface {
    ...
    boolean registerSDKUserInfo(String playerName, String customerID, String componentName, String subscriberID, String domainName,boolean doHash);
    boolean registerSDKUserInfo(String playerName, String customerID, String componentName, String subscriberID, String domainName, String subscriberType,boolean doHash);
    boolean registerSDKUserInfo(String playerName, String customerID, String componentName, String subscriberID, String domainName, String subscriberType, String subscriberTag,boolean doHash);

    void trackSegment(long startTimeMillisec, long size, int bitrate, int height, int width, float fps, String aCodec,String vCodec);

    void reportCustomMetadata(String key, String value);
    //ag
    void setInternalSubscriberID(Context appCtx,boolean doHash);
   ...
   // void reportAdInfo(String adClient, String adId, Long adDuration, String adPosition, MMAdType adType, String adCreativeType, String adServer,String adResolution, int adPodIndex, int adPositionInPod, int adPodLength, boolean isBumper, double adScheduledTime);
     ...
     */
    public void setDeviceInformation(String brand, String deviceModel, String os, String osVersion, String telecomOperator, Integer screenWidth, Integer screenHeight, String deviceMarketingName);
